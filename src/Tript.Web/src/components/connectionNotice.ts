  ...
  switch (reachability) {
    case 'rejected':
      return {
        tone: 'error',
        message:
          'Tript has restarted since this page was opened. It issues a new launch key each time it '
          + 'starts, and this page still holds the old one, so it can no longer connect. Open the '
