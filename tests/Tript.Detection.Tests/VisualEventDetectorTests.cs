...
public class VisualEventDetectorTests
{
    ...
    public void BgraToGray_WeightsChannelsInBgraOrder()
    {
        ...
        // Hand-computed, truncated by the (byte) cast rather than rounded:   (10, 20, 200):
        // 0.299*200 + 0.587*20 + 0.114*10 = 59.80 + 11.74 + 1.14 = 72.68 -> 72   (200, 20, 10):
        // 0.299*10  + 0.587*20 + 0.114*200 =  2.99 + 11.74 + 22.80 = 37.53 -> 37   (0, 255, 0)  :
